...
export default function ShiningButton({ children }) {
  return (
    <button className="group cursor-pointer rounded-xl  bg-transparent p-1 transition-all duration-500 hover:border-opacity-100">
